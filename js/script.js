...
var calculateAge = function(birthYear, thisYear){
 	...
 	var youngAge = age -1;
 	return "You are either " + youngAge + " or " + age;
}
...
//  var calculateSupply = function (teaPerMonth, age){
//  		var maxAge = 100;
//  		var years = maxAge - age;
//  		var months = years * 12;
//  		var totalTea = months * teaPerMonth;
//  		var string = "You will need ";
//  		string += totalTea ;
//  		string += " cups of tea to last you until the ripe old age of ";
